<?php
define("RUTA_RAIZ","");
include_once("_SiteLayout.php");

$strError = "";
if(parametro("cliente")!=""){// Si viene del formulario
		...
		if($password!=""){
			...
			if($NumElementos!=1){
				...
				if(intval(ValorCelda($resultado,0,"bActivo"))){
					...
					$_SESSION["sFRONT_Usuario_ID"] 	   	= intval(ValorCelda($resultado,0,"Usuario_ID"));
					$_SESSION["sFRONT_UsuarioRol_ID"] 	= intval(ValorCelda($resultado,0,"UsuarioRol_ID"));
					$_SESSION["sFRONT_Usuario_Nombre"] 	= stripslashes(ValorCelda($resultado,0,"Nombre"));
					$_SESSION["sFRONT_Usuario_Login"]	 	= stripslashes(ValorCelda($resultado,0,"Login"));
					$_SESSION["sFRONT_Usuario_Email"]	 	= stripslashes(ValorCelda($resultado,0,"Email"));
					
					//echo $_SESSION["sFRONT_Cliente_ID"];
					$_SESSION["sFRONT_Idioma"] 					= $idioma;
					switch ($idioma)
					{
						case "es":
							$_SESSION["sFRONT_Idioma_ID"] = 1;
							$_SESSION["sFRONT_Idioma-txt"] = TextoDeIdioma("idioma_txt_es");
							$_SESSION["sFRONT_Idioma-txt-det"] = TextoDeIdioma("idioma_txt_det_es");
							break;
						case "en":
							$_SESSION["sFRONT_Idioma_ID"] = 2;
							$_SESSION["sFRONT_Idioma-txt"] = TextoDeIdioma("idioma_txt_en");
							$_SESSION["sFRONT_Idioma-txt-det"] = TextoDeIdioma("idioma_txt_det_en");
							break;
						case "ja":
							$_SESSION["sFRONT_Idioma_ID"] = 3;
							$_SESSION["sFRONT_Idioma-txt"] = TextoDeIdioma("idioma_txt_ja");
							$_SESSION["sFRONT_Idioma-txt-det"] = TextoDeIdioma("idioma_txt_det_ja");
							break;
						case "ca":
							$_SESSION["sFRONT_Idioma_ID"] = 4;
							$_SESSION["sFRONT_Idioma-txt"] = TextoDeIdioma("idioma_txt_ca");
							$_SESSION["sFRONT_Idioma-txt-det"] = TextoDeIdioma("idioma_txt_det_ca");
							break;
					}
					
					//Inserto registro en el log.
					$Acceso = TextoDeIdioma("Correcto");
					InsertLog ($_SESSION["sFRONT_Usuario_ID"],$IP,$Fecha,$login,$password, $Acceso);

					ExecPA("UPDATE tbUsuario SET FechaUltimoAcceso = '".date("Y-m-d H:i:s")."' WHERE Usuario_ID = ".$_SESSION["sFRONT_Usuario_ID"]);
					
					// Redirijo
					header("location: ".SERVER.DOC_ROOT.DIR_FRONTCONTROL."index.php");
					die();
				}else{

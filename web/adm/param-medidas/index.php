...
ComprobarLoginPanel();
$strHtmlFrame = CabeceraPanelControl(SEC_ADM_PARAMETROS_MEDIDAS);
echo $strHtmlFrame;
...
if($bBorrar){
	...
	{
		$PA = "DELETE FROM tbMedida WHERE Medida_ID = ".intval($ID);
		//echo $PA;		die(); 
		ExecPA($PA);
		$strMsg .= TextoDeIdioma("Borrando") . " " . TextoDeIdioma("medida") . "... #" . $ID . ".<br />";
  ...
  if ($borrados > 0)
	{
		if ($borrados == 1)
		{
			$strMsg .= "<br />" . TextoDeIdioma("Se_ha_borrado") . " " . $borrados . " " . TextoDeIdioma("medida") . ".<br />";
		}else{
			$strMsg .= "<br />" . TextoDeIdioma("Se_han_borrado") . " " . $borrados . " " . TextoDeIdioma("medidas") . ".<br />";
		}
	}
}
...
$strSQLCount = "SELECT COUNT(*) FROM tbMedida ".$strSQLWhere;
...
?>
	...
	<div class="page-header">
		...
		<div class="pull-right">
	        ...
	        <li><?php echo TextoDeIdioma("Medidas")?><span class="divider">/</span></li>
				<li class="active"><?php echo TextoDeIdioma("Listado_de_medidas")?></li>
			</ul>
		</div>
	</div>
			...
			<div class="span12">
				<div class="box">
					...
					<div class="box-head">
						...
						<span><?php echo TextoDeIdioma("Medidas")?></span>
					</div>
					<div class="box-body box-body-nopadding">
						<div class="alert alert-info">
						...
						<form action="index.php" name="frmBorrar" method="post">
							...
							<table class="table table-nomargin table-bordered table-striped table-hover table-pagination">
								<thead>
									<tr>
										<?php echo CampoCabeceraTablaListado("Medida_ID", TextoDeIdioma("Codigo"), $orden, $paginaHtml, $paramsFiltro, $htmlTipoOrdenASC, $htmlTipoOrdenDESC, "center");?>
										...
										<th style="text-align:center"><?php echo TextoDeIdioma("Categorias")?></th>
								...
								<?php 
									...
									{
										$Medida_ID 	= intval(ValorCelda($resultado,$i,"Medida_ID"));
										...
										$sqlComboSel = "SELECT tbCategoriaMedida.Categoria_ID, tbCategoriaMedida.Medida_ID, tbCategoria.Nombre
																				FROM tbCategoriaMedida INNER JOIN tbCategoria ON tbCategoriaMedida.Categoria_ID = tbCategoria.Categoria_ID  
										...
										for($m=0;$m<$NumElComboSel;$m++)
										{
											...
											$strCatsSel 	.= stripslashes(ValorCelda($resComboSel,$m,"Nombre")).", ";
										}
										$strCatsSel = substr($strCatsSel, 0, -2);
										$strHtml .= "<tr>";
										$strHtml .= "	<td style=\"text-align:center;vertical-align:middle\">".$Medida_ID."</td>";
										$strHtml .= "	<td style=\"vertical-align:middle\">".$Nombre."</td>";
										$strHtml .= "	<td style=\"text-align:center;vertical-align:middle\">".$Orden."</td>";
										$strHtml .= "	<td style=\"text-align:center;vertical-align:middle\">".$strCatsSel."</td>";
										...
										$strHtml .= "</td>";
										$strHtml .= "	<td style=\"text-align:center;vertical-align:middle\"><a href=\"editar.php?Medida_ID=".$Medida_ID."\"><img src=\"".RUTA_ADM."/img/icons/attibutes.png\" alt=\"".TextoDeIdioma("Editar")."\" width=\"32\" /></a></td>";
										$strHtml .= " <td style=\"text-align:center;vertical-align:middle\"><input type=\"checkbox\" name=\"chkBorrar[]\" value=\"".$Medida_ID."\" /></td>";
										$strHtml .= "</tr>";
									}
									echo $strHtml;
								?>

...
ComprobarLoginPanel();
$strHtml = CabeceraPanelControl(SEC_ADM_PROVEEDORES);

echo $strHtml;

	$Proveedor_ID = intval(parametro("Proveedor_ID"));
	if($Proveedor_ID == 0){
		$accion = ACCION_NUEVO;
		$required = "true";
		...
		$PA="SELECT * FROM tbProveedor WHERE Proveedor_ID = ".$Proveedor_ID;
		$resultado = ExecPA($PA);
		...
		if($NumElementos == 0){
			...
			$bBoletin						= intval(ValorCelda($resultado,0,"bBoletin"));
			if($bBoletin==1){
				$strBoletin = "checked";
			}else{
				$strBoletin = "";
			...
			<div class="container-fluid" id="content-area">
				...
				<div class="row-fluid">
							...
							<div class="box-body box-body-nopadding">
								...
								<form name="frmDatos" id="frmDatos" action="proceso.php" method="post" class="form-horizontal form-bordered form-validate">
									...
									<div class="control-group">
										...
										<div class="controls">
											<span class="uneditable-input input-mini"><?php echo $Proveedor_ID?></span>
                  ...
                  <?php }?>
									...
									<div class="control-group">
										<label for="nombre" class="control-label"><?php echo TextoDeIdioma("Nombre_contacto")?></label>
										<div class="controls">
									...
									<div class="control-group">
										<label for="apellidos" class="control-label"><?php echo TextoDeIdioma("Apellidos_contacto")?></label>
										<div class="controls">
									...
									<div class="control-group">
										<label for="nif" class="control-label"><?php echo TextoDeIdioma("CIF")?></label>
										<div class="controls">

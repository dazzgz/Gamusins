...
ComprobarLoginPanel();
$strHtmlFrame = CabeceraPanelControl(SEC_ADM_PROVEEDORES);
echo $strHtmlFrame;
...
if($bBorrar){
	...
	{
		$PA = "DELETE FROM tbProveedor WHERE Proveedor_ID = ".intval($ID);
		//echo $PA;
		//die(); 
		ExecPA($PA);
		$strMsg .= TextoDeIdioma("Borrando") . " " . TextoDeIdioma("proveedor") . "... #" . $ID . ".<br />";
  ...
  if ($borrados > 0)
	{
		if ($borrados == 1)
		{
			$strMsg .= "<br />" . TextoDeIdioma("Se_ha_borrado") . " " . $borrados . " " . TextoDeIdioma("proveedor") . ".<br />";
		}else{
			$strMsg .= "<br />" . TextoDeIdioma("Se_han_borrado") . " " . $borrados . " " . TextoDeIdioma("proveedores") . ".<br />";
		}
	}
}
...
$strSQLCount = "SELECT COUNT(*) FROM tbProveedor".$strSQLWhere;
...
?>
	...
	<div class="page-header">
		...
		<div class="pull-right">
	        ...
	        <li><?php echo TextoDeIdioma("Proveedores")?><span class="divider">/</span></li>
				<li class="active"><?php echo TextoDeIdioma("Listado_de_proveedores")?></li>
			</ul>
		</div>
	</div>
	...
	<?php
	$PA = "SELECT DISTINCT ";
	$PA .= "		Proveedor_ID, Usuario_ID, Nombre, Apellidos, Email, NIF, RazonSocial";
			...
			<div class="span12">
				<div class="box">
					...
					<div class="box-head">
						...
						<span><?php echo TextoDeIdioma("Proveedores")?></span>
					</div>
					<div class="box-body box-body-nopadding">
						<div class="alert alert-info">
						...
						<form action="index.php" name="frmBorrar" method="post">
							...
							<table class="table table-nomargin table-bordered table-striped table-hover table-pagination">
								<thead>
									<tr>
										<?php echo CampoCabeceraTablaListado("Proveedor_ID", TextoDeIdioma("Codigo"), $orden, $paginaHtml, $paramsFiltro, $htmlTipoOrdenASC, $htmlTipoOrdenDESC, "center");?>
								...
								<?php 
									...
									for($i=0;$i<$NumElementos;$i++)
									{
										...
										$strHtml .= "<tr>";
										$strHtml .= "	<td style=\"".$colorFila."vertical-align:middle;text-align:center;\">".$Proveedor_ID."</td>";
										//$strHtml .= "	<td style=\"".$colorFila."vertical-align:middle;text-align:left;\">".ExecQueryValue("SELECT CONCAT(Nombre, ' ', Apellidos) FROM tbCliente WHERE Cliente_ID = ".$Agente_ID)."</td>";
										...
										if($_SESSION["sPANEL_UsuarioRol_ID"] < ROL_PROVEEDOR_ID ){
											$strHtml .= "	<td style=\"".$colorFila."vertical-align:middle;text-align:center;\"><a href=\"editar.php?Proveedor_ID=".$Proveedor_ID."\"><img src=\"".RUTA_ADM."/img/icons/attibutes.png\" alt=\"".TextoDeIdioma("Editar")."\" width=\"32\" /></a></td>";
											$strHtml .= " <td style=\"".$colorFila."vertical-align:middle;text-align:center;\"><input type=\"checkbox\" name=\"chkBorrar[]\" value=\"".$Proveedor_ID."\" /></td>";
										}
										$strHtml .= "</tr>";
									}
									echo $strHtml;
